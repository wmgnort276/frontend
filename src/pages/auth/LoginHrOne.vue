...
const formState = reactive<FormState>({
  username: '',
  password: '',
  type: [USER_TYPE.MANAGER, USER_TYPE.SYSTEM_ADMIN]
});
          ...
          <a-form :model="formState">
            <a-row align="middle" class="item">
              ...
              <a-col :sm="20" :md="16" :lg="16">
                <a-form-item>
                  <a-input v-model:value="formState.username" :placeholder="$t('login.form.placeholder.id')"
                    class="input" />
                </a-form-item>
              </a-col>
            </a-row>
              ...
              <a-col :sm="20" :md="16" :lg="16">
                <a-form-item name="password" :rules="[{ message: 'Please input your password!' }]">
                  <a-input-password v-model:value="formState.password"
                    :placeholder="$t('login.form.placeholder.password')" class="input">
                  </a-input-password>
                </a-form-item>
              </a-col>
            </a-row>
